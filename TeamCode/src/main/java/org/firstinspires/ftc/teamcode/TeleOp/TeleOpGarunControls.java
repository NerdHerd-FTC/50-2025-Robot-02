...
public class TeleOpGarunControls extends OpMode {
    ...
    final double ARM_COLLECT               = (7   * ARM_TICKS_PER_DEGREE);
    final double ARM_CLEAR_BARRIER         = (226 * ARM_TICKS_PER_DEGREE);
    final double ARM_SCORE_SPECIMEN        = (143 * ARM_TICKS_PER_DEGREE);
    final double ARM_SCORE_SAMPLE_IN_LOW   = (160 * ARM_TICKS_PER_DEGREE);
    final double ARM_ATTACH_HANGING_HOOK   = (122 * ARM_TICKS_PER_DEGREE);
    final double ARM_WINCH_ROBOT           = (36  * ARM_TICKS_PER_DEGREE);
