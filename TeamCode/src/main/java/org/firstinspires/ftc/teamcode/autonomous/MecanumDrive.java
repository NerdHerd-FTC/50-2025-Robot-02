...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.002968434004;
        public double lateralInPerTick = 0.002312354744819251;
        public double trackWidthTicks = 5072.505478454323;

        // feedforward parameters (in tick units)
        public double kS = 0.7536074313510257;
        public double kV = 0.0005598886901326559;
        public double kA = 0.000002;

        // path profile parameters (in inches)
        public double maxWheelVel = 70  ;//250;
        public double minProfileAccel = -30; //-40;
        public double maxProfileAccel =  50 ;//300;
        ...
        public double headingGain = 0.6; // shared with turn
